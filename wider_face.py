...
label_dir="/home/py/code/mana/yolov5-master/face_yolov5_label"
f_train =open("train.txt", "w")

aa=WiderFaceDetection("/home/py/code/github/Pytorch_Retinaface/data/widerface/train/label.txt")

for i in range(len(aa.imgs_path)):
    img = cv2.imread(aa.imgs_path[i])
    print(i)
    f_train.write(aa.imgs_path[i] +"\n")
    base_name =os.path.basename(aa.imgs_path[i]) +".txt"
    # abs_save_path =os.path.join(label_dir,base_name)
